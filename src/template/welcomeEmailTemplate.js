export const welcomeEmail = ({name,email}) => {
    ...
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="color: #4a90e2; font-size: 2em;">Welcome to The Victuals</h1>
      </div>
      ...
      <div style="text-align: center;">
        <p style="color: #555; margin-bottom: 10px;">
          Best regards,<br>
          <a href="https://navv.info" style="color: #4a90e2; text-decoration: none; font-weight: bold;">The Victuals / navv.info</a>
        </p>
